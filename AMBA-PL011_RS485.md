...
## 3. 설명
 ...
 전송제어(TxEN)신호 타이밍을 효율적으로 관리하기 위해 다음과 같은 기능을 추가합니다.
   ...
   - 타이머1,타이머2를 사용하여 트랜시버의 리셋 시간을 지연
	 * **타이머1**을 추가하여 트랜시버 버퍼 상태를 체크합니다. 
     * **타이머2**을 추가하여 트랜시버의 전송제어(TxEN)신호 타이밍을 지연시킵니다.


### - 동작 설명

 - **타이머1**: 트랜시버 버퍼 상태 체크 타이밍 계산
 ...
 - **타이머2**: 트랜시버의 전송제어(TxEN)신호 타이밍 지연
 ...
 ![ABCDEFG](images/AMBA-PL011_RS485_02.png) 
